...
const messages = defineMessages({
  ...
  description: {
    id: 'description',
    defaultMessage: 'Photography Business Website for Masha Eltsova Photography'
  },
  email: {
    id: 'email',
  ...
  errFirstNameVal: {
    id: 'firstNameInvalid',
    defaultMessage: 'Invalid first name. Only alpha characters.'
  },
  errFirstNameLen: {
    id: 'firstNameLength',
    defaultMessage: 'First name must be at least 2 characters in length.'
  },
  errLastNameReq: {
    id: 'lastNameRequired',
  ...
  errLastNameVal: {
    id: 'lastNameInvalid',
    defaultMessage: 'Invalid last name. Only alpha characters.'
  },
  errLastNameLen: {
    id: 'lastNameLength',
    defaultMessage: 'Last name must be at least 2 characters in length.'
  },
  errEmailReq: {
    id: 'emailRequired',
  ...
  errorRes: {
    id: 'errorResponse',
    defaultMessage:
      'There was a problem with your request, please try back later.'
  },
  errPhoneReq: {
    id: 'phoneRequired',
  ...
  errPhoneVal: {
    id: 'phoneInvalid',
    defaultMessage:
      'Invalid phone number. Accepts: +1-234-567-8901, +61-234-567-89-01.'
  },
  firstName: {
    id: 'firstName',
  ...
  message: {
    id: 'message',
    defaultMessage: 'What are your booking needs?'
  },
  phone: {
    id: 'phone',
  ...
  rcws: {
    id: 'rcws',
    defaultMessage: 'RCWS Development'
  },
  servicesMessage: {
    id: 'servicesMessage',
    defaultMessage:
  ...
  successRes: {
    id: 'successResponse',
    defaultMessage: 'Your booking request was sent!'
  },
  title: {
    id: 'title',
    defaultMessage: 'Masha Eltsova Photography'
  }
})
