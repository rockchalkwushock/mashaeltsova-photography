...
export const createThumbnail = (condition, id) =>
  condition === 'travel' || condition === 'путешествия'
    ? `https://res.cloudinary.com/${process.env
        .CLOUD_NAME}/c_thumb,f_auto,g_center,h_200,q_auto:good,w_200/${id}`
    : `https://res.cloudinary.com/${process.env
        .CLOUD_NAME}/c_thumb,f_auto,g_faces:auto,h_100,q_auto:good,w_100/${id}`
